    ...
    <div>
      <div className="offers">
        <div className="offer">
          ...
          <p>
            Enjoy our exclusive weekend offer on 2 Large pizza for big
        ...
        <div className="offer">
          ...
          <h3>Lunch Combo</h3>
          <p>
            Delicious lunch combo at 5% discounted price. Available every
            weekday.
          </p>
          <div className="offer-details">
            <ul>
              ...
              <li>
                Choose from a variety of combos based on your preferences.
              </li>
        ...
        <div className="offer">
          ...
          <p>
            Feast with your family with our specially curated family meal deal.
          ...
          <div className="offer-details">
            <ul>
              ...
              <li>
                Includes a choice of main course, sides, and beverages for each
                member.
              </li>
