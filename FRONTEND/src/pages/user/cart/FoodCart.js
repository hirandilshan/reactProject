...
export default function FoodCart() {
  ...
  function removeItem(itemId) {
    ...
    axios
      .delete(
        `https://reactproject-6y6b.onrender.com/cart/remove/${cartItems._id}`
      )
      .then(() => {
  ...
  function increse(itemId) {
    ...
    axios
      .put(
        `https://reactproject-6y6b.onrender.com/cart/increse/${cartItems._id}`,
        newItem
      )
      .then(() => {
        setItems((currentItems) =>
  ...
  function decrese(itemId) {
    ...
    axios
      .put(
        `https://reactproject-6y6b.onrender.com/cart/decrese/${cartItems._id}`,
        newItem
      )
      .then(() => {
        setItems((currentItems) =>
                ...
                return (
                  <>
                    <tr>
                      ...
                      <td>
                        <button onClick={() => decrese(items._id)} name="minus">
                          (-)
                        </button>
                      </td>
                      <td>{items.numOfItems}</td>
                      <td>
                        <button onClick={() => increse(items._id)} name="plus">
                          (+)
                        </button>
                      </td>
                      <td>
