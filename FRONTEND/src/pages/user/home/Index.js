...
export default function Index() {
  ...
  const sendData = (e) => {
    ...
    axios
      .post(
        "https://reactproject-6y6b.onrender.com/review/addReview",
        newReview
      )
      .then(() => {
    ...
    <div className="home">
      <Carousel>
        ...
        <Carousel.Item>
          ...
          <Carousel.Caption>
            <h2 style={{ fontWeight: "bold", color: "rgb(245, 101, 34)" }}>
              ENJOY YOUR MEALS
            </h2>
      ...
      <div className="main_slide">
        <div>
          <h1>
            Enjoy <span>Delicious Food</span> is Your Healthy Life.
          </h1>
          <p>
            EAT OUT Restaurant has been a local favorite for more than a decade,
            situated near the coastal lines of the western province of Sri
            Lanka. Savannah is known for its authentic Sri Lankan food, exotic
            Indian and Chinese cuisine and a blend of western and continental
            dishes.
          </p>
          <Link to="/foodMenu">
      ...
      <CardGroup>
        ...
        <Card>
          ...
          <Card.Body>
            ...
            <Card.Text>
              Using curd instead of cheese, this kottu has a tart kick that's
              also fatty and milky in a way that works with spices at play
            </Card.Text>
          </Card.Body>
          <Card.Footer>
            <small className="text-muted">
        ...
        <Card>
          ...
          <Card.Body>
            ...
            <Card.Text>
              Biryani, flavourful rice dish of Persian origin that has become a
              popular celebratory dish in South Asia
            </Card.Text>
          </Card.Body>
          <Card.Footer>
            <small className="text-muted">
      ...
      <div className="main_slide3">
        ...
        <div className="fav-food">
          ...
          <div className="item">
            <div>
              <img
                src="images/chicken_fried_rice00032a-1200x1200-1.jpg"
                alt=""
              ></img>
            </div>
      ...
      <div className="main_slide4">
        <div className="chef-feed">
          <h2>
            Customer <span style={{ color: "red" }}>Feedback</span>
          </h2>
          <p>
            I recently had the pleasure of dining at this amazing restaurant,
            and I must say it was an absolute delight. From the moment I walked
            in, the ambiance was welcoming and comforting. The decor was
            tasteful and set the perfect mood for a delightful meal
          </p>
